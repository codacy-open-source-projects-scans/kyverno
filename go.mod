...
require (
	...
	github.com/aptible/supercronic v0.2.36
...
replace k8s.io/pod-security-admission v0.34.1 => github.com/kyverno/pod-security-admission v0.0.0-20250314164903-c9a58987cebb
